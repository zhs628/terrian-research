...
base_config = {'post_operations': [('Threshold(x, param)', 0.54)], 'seed': 123456}



layers_config = [   {   'falloff': 6.93,
        'lacunarity': 0.0,
        'noise_type': 'Voronoi',
        'octaves': 1,
        'operations': [   ('Laplace(pos)', 1.0),
                          ('Multiply(x, param)', -1.0),
                          ('Sigmoid(x, param)', 20.0)],
        'persistence': 0.0,
        'radius': 1,
        'scale': 22.67}]
...
if __name__ == '__main__':
    ...
    result = noise_area(vec2i(0, 0), 64, 64, 1, base_config['seed'])
